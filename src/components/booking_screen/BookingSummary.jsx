...
export default function BookingSummary() {
  ...
  const rescheduleEvent = () => {
    if (checked === false) {
      ...
      navigation.navigate('Reschedule', {bookingInfo: orderData});
  ...
  const handlingEventStatus = () => {
    ...
    // Handle "Ticket Raised" status
    if (orderData.order_status === 'Ticket Raised') {
      return (
        <>
          <Text
            style={{
            ...
            <FontAwesome6 name="ticket" size={20} color="#ad2b2b" /> Ticket
            Raised
          </Text>
        ...
        //       textAlign: 'center',
        //     }}>
        //     <FontAwesome6 name="ticket" size={20} color="#ad2b2b" /> View Ticket
        //   </Text>
        // </TouchableOpacity> */}
        </>
      );
          ...
          <ScrollView>
            ...
            {orderData.bookingStatus}
              ...
              <View>
                ...
                {orderData.tech_data?.map((item, productIndex) => (
                  <View
                    key={productIndex}
                    style={{
                      flexDirection: 'row',
            ...
            <View style={{marginHorizontal: 10}}>
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    Linking.openURL(
                      'https://kadagamfoundation.org/activities/food-donation',
                    )
                  }>
                  <Text
                    style={{
                  ...
                  <View>
                    <Text
                      ...
                      <MaterialIcons
                        ...
                        color="black"
                      />
                      {orderData?.base_amount?.toFixed(2)}
                    </Text>
                  </View>
                </View>
                    ...
                    <View>
                      <Text
                        ...
                        <MaterialIcons
                          ...
                          color="black"
                        />
                        {orderData?.tds_deduction?.toFixed(2)}
                      </Text>
                    </View>
                  </View>
                )}
                    ...
                    <View>
                      <Text
                        ...
                        <MaterialIcons
                          ...
                          color="black"
                        />
                        {orderData?.amount_after_deduction?.toFixed(2)}
                      </Text>
                    </View>
                  </View>
                )}
              ...
              <View style={{padding: 10}}>
                ...
                <View style={{marginTop: 10}}>
                  ...
                  <Text
                    ...
                    From - {moment(orderData?.event_start_date).format('LL')}
                  </Text>
                  <Text
                    style={{
                      fontSize: 12,
                    ...
                    To - {moment(orderData?.event_end_date).format('LL')}
                  </Text>
                </View>
                <View style={{marginTop: 10}}>
                  <Text
                  ...
                  <Text
                    ...
                    {orderData?.event_start_time} - {orderData?.event_end_time}
                  </Text>
                </View>
                <View
                  style={{
                  ...
                  <View style={{flex: 0.6, alignItems: 'flex-end'}}>
                    {orderData?.upload_invitation ? (
                      <Image
                        source={{uri: orderData?.upload_invitation}}
                        style={{
                          width: 100,
                          height: 50,
                        }}
                ...
                <View
                  ...
                  <View style={{flex: 0.6, alignItems: 'flex-end'}}>
                    {orderData?.upload_gatepass ? (
                      <Image
                        source={{uri: orderData?.upload_gatepass}}
                        style={{
                          width: 100,
                          height: 50,
                        }}
